...
LEFT JOIN stella_common.risk_types_t risk_type ON d.risk_type_id = risk_type.risk_type_id
LEFT JOIN stella_common.risk_types_t rtm ON risk_type.risk_type_major_id__risk_types_t  = rtm.risk_type_id
LEFT JOIN stella_common.insurers_t ins ON d.primary_insurer = ins.id
LEFT JOIN
broker_firms_t bf
...
LEFT JOIN stella_common.underwriters_t iaq ON d.internal_approver = iaq.uw_id
LEFT JOIN stella_common.underwriters_t iab ON d.internal_approver_at_signing = iab.uw_id
